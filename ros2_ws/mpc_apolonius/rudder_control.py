...
def generate_evasion_rudder(current_state, pursuer_states, goal_state):
    ...
    K_att = 0.04     # Reduced attractive gain to prioritize evasion
    K_rep_base =400000.0  # Increased base repulsive gain
    d0 = 8.0          # Increased influence radius for earlier evasion
    eps = 1e-6
    max_tc = 10.0       # Reduced max time-to-collision for quicker response

    # Increased PD gains for more aggressive maneuvers
    Kp = 0.05
    Kd = 0.5           # Increased derivative gain
    max_rudder_deg = 35.0
