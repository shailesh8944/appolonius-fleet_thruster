...
from module_kinematics import Smat, eul_to_rotm, eul_rate_matrix
...
class Vessel:
    ...
    def vessel_ode(self, t, state):
        ...
        #     #     print(f"delta_c, rudder command: {self.delta_c}")
        #     # else:
        #     #     raise ValueError(f"Invalid control type: {self.control_type}")  
        #     print("vessels------ode rudder sngle",self.delta_c)
        #     print(f"Current rudder (rad): {delta:.4f}")
        #     print(f"Commanded rudder (rad): {self.delta_c:.4f}")
        #     #delta=self.delta_c
        #     #print(f"delta_c, rudder command: {self.delta_c}")
