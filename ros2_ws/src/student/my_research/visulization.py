...
class PursuitAnimation:
    ...
    def __init__(self, states_pursuer1, states_pursuer2, states_pursuer3, states_evader,
        ...
        self.l = 23  # Characteristic length for non-dimensionalization
    ...
    def draw_capture_circle(self, ax, evader_pos, radius=1.5/230, color='red', alpha=0.2):
    ...
    def init_animation(self):
        ...
        self.ax.grid(True)
        self.ax.set_xlim([0, 100/ self.l])
        self.ax.set_ylim([0, 100/ self.l])
