...
class PursuitAnimation:
    ...
    def __init__(self, states_pursuer1, states_pursuer2, states_pursuer3, states_evader,
        ...
        self.l = 230  # Characteristic length for non-dimensionalization
    ...
    def draw_ship(self, ax, x, y, psi, color='b'):
        ...
        length = 1/self.l;  # Ship length
        width = .4/self.l  # Ship width
    ...
    def draw_capture_circle(self, ax, evader_pos, radius=0.5/230, color='red', alpha=0.2):
     """Draw a capture circle around the evader"""
     if radius is None:
        # Make radius relative to plot size
        plot_width = self.ax.get_xlim()[1] - self.ax.get_xlim()[0]
        radius = (5/self.l) * (plot_width/30)  # Adjust radius relative to plot size
    ...
    def init_animation(self):
        ...
        self.ax.grid(True)
        self.ax.set_xlim([-100/self.l, 100/ self.l])
        self.ax.set_ylim([-100/self.l, 100/ self.l])
    ...
    def save_frames(self, save_dir):
        ...
        for frame in range(0, len(self.states_pursuer1), frame_interval):
            ...
            plt.savefig(frame_path, dpi=300, bbox_inches='tight',facecolor='none',edgecolor='none')
